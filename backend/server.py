...
from backend.api.v1.routes import academic_year_routes, board_routes, branch_routes, class_setup_routes, exam_term_routes, grading_scheme_routes, holiday_routes, profile_routes, subject_routes  # noqa: E402

...
from backend.api.v1.routes import academic_session_routes, academic_year_routes, admission_enquiry_routes, admission_form_routes, board_routes, branch_routes, class_setup_routes, exam_term_routes, grading_scheme_routes, holiday_routes, profile_routes, room_routes, subject_routes  # noqa: E402
